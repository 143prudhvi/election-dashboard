...
const HimachalRegionMap = () => {
    ...
    var assemblies = feature(geoData,geoData.objects['Himachal Pradesh']);
    var partiesData2012 = []
    var partiesData2017 = []
    ...
    for(var k=0; k<partiesData2012.length;k++){
        partiesData2012[k].VotePercent = (partiesData2012[k].Votes/ totalVotes2012 * 100).toFixed(2)
    }
    
    for(var k=0; k<partiesData2017.length;k++){
        partiesData2017[k].VotePercent = (partiesData2017[k].Votes/ totalVotes2017 * 100).toFixed(2)
    }
...
export default HimachalRegionMap;