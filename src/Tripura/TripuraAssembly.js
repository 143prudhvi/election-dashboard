...
import data from '../Data/Tripura.json';
import electionData2017 from '../Data/Tripura-2023.json';
import { Link } from 'react-router-dom';
import "../GujaratAssembly/GujaratAssembly.css";
const TripuraAssemblyMap = () => {
  ...
  var assemblies = feature(data,data.objects['Tripura']);
  var AAP = {
    Party : "AAP",
    Seats : 0,
    Votes : 0,
  ...
  useEffect(() => {
    ...
    const center =  [92.5,23.5]
    const projection = geoMercator().center(center).scale(12000).precision(100);
  ...
  return (
    <div ref={wrapperRef}>
      ...
      <div className='map'>
        ...
        <svg className='svg-map' width={width} height={height-200} ref={svgRef}></svg>
      </div>
...
export default TripuraAssemblyMap;